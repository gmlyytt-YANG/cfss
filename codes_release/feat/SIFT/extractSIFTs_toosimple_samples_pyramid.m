...
function featOri_batch = extractSIFTs_toosimple_samples_pyramid(images,currentPose_samples,iter,featInfo, level, mode)
...
featOri_total = extractSIFTs_toosimple(images,pose,iter,featInfo, level, 0, 'extractSIFTs_toosimple_samples_pyramid', mode);
