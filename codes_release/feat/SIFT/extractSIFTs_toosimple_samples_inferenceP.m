...
function featOri_batch = extractSIFTs_toosimple_samples_inferenceP(images,currentPose_samples,iter,featInfo, level, ii, mode)
...
featOri_total = extractSIFTs_toosimple(images,pose,iter,featInfo, level, ii, 'extractSIFTs_toosimple_samples_inferenceP', mode);
