...
function featOri_batch = extractSIFTs_toosimple_samples(images,currentPose_samples,iter,featInfo, level)
...
featOri_total = extractSIFTs_toosimple(images,pose,iter,featInfo, level, 'extractSIFTs_toosimple_samples');
